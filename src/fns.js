...
// SYNAPSE CLUSTERING
  ...
  function arborRegions() {
    return realSynapseClustering.findArborRegions(arbor, fcs, fraction);
  }

  function findAxon() {
    return realSynapseClustering.findAxon(arborParser, fraction, locations);
  }
...
module.exports.makeFns = makeFns;
